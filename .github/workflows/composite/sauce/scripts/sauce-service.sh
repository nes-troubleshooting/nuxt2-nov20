...
readonly SAUCE_READY_FILE_TIMEOUT=${SAUCE_READY_FILE_TIMEOUT}
...
service-setup-command() {
  ...
  case "${machine}" in
    ...
    linux)
      SAUCE_CONNECT="sc";; #${SCRIPT_DIR}/../../node_modules/sauce-connect-launcher/sc/sc-${SAUCE_CONNECT_VERSION}-linux/bin/sc";;
    *)
